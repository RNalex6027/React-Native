    ...
    render(){
        return (
          <View style={[commonStyle.wrapper, loginStyle.loginWrap]}>
            <Image source={require('../imgs/icons/bg.png')}>
                    ...
                    <View style={loginStyle.loginMainCon}>
                        <View style={loginStyle.formStyle}>
                            <View style={[loginStyle.formInput,loginStyle.formInputSplit]}>
                                <Image source={require('../imgs/icons/user.png')} style={{width:25,height:25,}}/>
                                <TextInput 
                                    ref="login_name" 
                            ...
                            <View style={loginStyle.formInput}>
                                <Image source={require('../imgs/icons/passicon.png')} style={{width:25,height:25,}}/>
                                <TextInput 
                                    ref="login_psw"  
                                    style={loginStyle.loginInput} 
                            ...
                            <View style={{alignItems: 'flex-end'}}>
                                ...
                                <View>
                                    <Image source={require('../imgs/icons/prompt.png')} style={{width:15,height:15,marginRight:10}}/>
                                </View>
                                <View >
